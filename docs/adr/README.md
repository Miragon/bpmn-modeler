...
| [0031](0031-vitest-browser-mode-for-bpmn-modeler.md) | Vitest browser mode (Playwright/Chromium) as a second project for `@miragon/bpmn-modeler`; real-ResizeObserver view-state specs, coverage off, shared aliases | accepted |
