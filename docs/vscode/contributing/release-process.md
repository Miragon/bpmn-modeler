...
slot (see below and [Release and publishing: release components and markers](https://github.com/Miragon/bpmn-modeler/blob/main/docs/adr/release-and-publishing.md#release-components-and-markers)),
...
([Release and publishing: release components and markers](https://github.com/Miragon/bpmn-modeler/blob/main/docs/adr/release-and-publishing.md#release-components-and-markers)).
