 ...
 *
 * Placed before the default text editor rather than hiding it, so the spike can
 * be verified by switching to the plain-text tab to confirm the round-tripped
 * XML on disk.
 */
