 ...
 *
 * A single application-level instance serves every editor: the static bundle is
 * identical across files, and all per-file data flows over the JCEF message
 * bridge, never over HTTP.
 */
