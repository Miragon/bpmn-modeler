/**
 * Fixture BPMN XML pair for the `computeDiff` unit tests.
 *
 * The two diagrams differ in every category `bpmn-js-differ` reports, so one
 * `computeDiff` call exercises all four highlight buckets and the flow-order
 * sorting:
 *
