export class BpmnModelerSetting {
    constructor(
        ...
        public readonly fitOnDrilldown: boolean,
    ) {}
}
...
export class SettingBuilder {
    ...
    fitOnDrilldown(value: boolean): SettingBuilder {
        this._fitOnDrilldown = value;
        return this;
    }
