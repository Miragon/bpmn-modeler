export class BpmnModelerSetting {
    constructor(
        ...
        public readonly compactExternalLabels: boolean,
    ) {}
}
...
export class SettingBuilder {
    ...
    private _compactExternalLabels = false;
    ...
    compactExternalLabels(value: boolean): SettingBuilder {
        this._compactExternalLabels = value;
        return this;
    }
