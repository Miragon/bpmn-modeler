/**
 * The custom-editor `viewType` identifiers, kept in one vscode-free module
...
// Custom-editor viewType for `.form` files.
export const FORM_VIEW_TYPE = "bpmn-modeler.form";
